...
class mygui:
    def __init__(self):
        ...
        #USER NAME ENRTY
        lbl_sign=tk.Label(master=self.frm_log,text="GWAPO",font=("Goudy Old Style",20),bg="white",cursor="cross")
        ...
        btn_forget=tk.Button(master=self.frm_log,text="Forget Password?",font=("Alkatra",11),bg="white",fg="#0347ad",cursor="hand2",border=0,activebackground="white")
